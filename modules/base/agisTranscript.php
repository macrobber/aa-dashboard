...
class owa_agisTranscriptController extends owa_reportController {
    ...
    function action() {
        ...
        // set view stuff
        $this->setSubview('base.agisTranscript');
        #$this->setTitle('Funnel Visualization:', 'Goal ' . $goal_number);
        $this->setTitle('AGIS Chat Transcripts');
...
class owa_AgisTranscriptView extends owa_view {

    function render() {
	#echo "Hello world";
        $this->body->set_template('agisTranscript_template.php');
