...
define('OWA_DB_PASSWORD', 'K!llo555'); // database user's password
 ...
 */
define('OWA_NONCE_KEY', '(ApCD>2GP`o1[/:uX.Qi{w=Qci 1]5M1s vxdA!Ov<Zh yx&k,c&EbnCgA{Zq#ll');  
define('OWA_NONCE_SALT', '6@O{6CDr}d3kbw[.rwHH^?*?_T:RP&X|O,l~P[CEY1{2?IEo8B|DwFS7(}nc%)0-');
define('OWA_AUTH_KEY', '@vKa+|TUZKS80RC8.p*?g;0TefPv}yW~~0zO}~Em.;?=94vKah]ZX[{91gk%Zvo$');
define('OWA_AUTH_SALT', '0EQexoj4^. HLDd-+9-^knjf7D1c]V{|$#pj{=ItiCfd,M;&M9`XF@va1sCR[$24');
