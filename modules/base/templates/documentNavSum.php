<div class="agis-mobile-remove" style="background-image: url('<?php echo $this->makeImageLink('base/i/document_icon.gif');?>');background-repeat: no-repeat; padding:5px 5px 5px 35px; background-position:13px 5px;">
